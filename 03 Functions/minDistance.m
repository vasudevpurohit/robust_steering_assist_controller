...
%}
function [min_obstacle_dist,min_lane_dist]=minDistance(corners)
    ...
    if isempty(n)
        ...
        o1_x2=35.0; 
        o1_y1=-0.75; 
        o1_y2=1.75; %original - 1.75m 
        o2_x1=35.0; 
        o2_x2=75.0; 
        o2_y1=1.75; %original - 1.75m 
        o2_y2=1.75; %original - 1.75m 
        %segment that define the lane line
        l_x1=-10.0; 
        l_x2=80.0; 
        l_y1=5.0; %original - 5.0m 
        l_y2=5.0; %original - 5.0m 
    else
        %do nothing
    end
